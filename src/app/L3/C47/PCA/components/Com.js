    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="max-w-4xl w-full">
        ...
        <ol className="text-lg text-gray-600 space-y-2">
          ...
          <li>6. Find out which countries allow people to shop or do business using that crypto</li>
          <li>7. Include 2–3 things people can actually buy using this coin</li>
          <li>8. Add a picture of the cryptocurrency logo</li>
        </ol>
      </div>
    </div>
  );
