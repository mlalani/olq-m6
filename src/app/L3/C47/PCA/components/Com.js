    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="max-w-4xl w-full">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Slide 6:</h3>
            <p className="text-lg text-gray-600">How is cryptocurrency connected to Non fungible tokens [NFT]?</p>
          </div>
          
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Slide 7:</h3>
            <p className="text-lg text-gray-600">Design your own cryptocurrency. Add a picture and name.</p>
          </div>
        </div>
      </div>
    </div>
